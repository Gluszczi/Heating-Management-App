        ...
        handler.post(new Runnable()
        {
            ...
            public void run() {
                ...
                for(int i = 0; i< MainActivity.roomList.size(); i++)
                {
                    ...
                    if(!MainActivity.roomList.get(i).getBooleanActiveSchedule())
                    {
                        textView.setText(String.valueOf(MainActivity.roomList.get(i).getTemp()));
                    }
                    ...
                    if(MainActivity.roomList.get(i).getBooleanActiveSchedule())
                    {
                        ...
                        timeFrameHandlerList = MainActivity.roomList.get(i).getTimeFrameHandlerList();
